  ...
  return (
    <div className="App">
      <div className="bg-hero bg-cover bg-center pb-80">
        <Header />
        <h1 className="mt-20 ml-20 text-8xl font-bold text-left">THE NEXT AGE OF SPACE SIGHTSEEING</h1>
      ...
      <div className="mt-20 bg-black pb-80">
        <h1 className="ml-20 text-8xl font-bold text-center">THE NEXT AGE OF SPACE SIGHTSEEING</h1>
