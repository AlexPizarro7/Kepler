        ...
        <div className="container">
                <div className="tab-content translations-content-item en visible" id="en">
                    ...
                    <ul>
                        ...
                        <li>
                            <p><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Kepler.</p>
                        </li>
                        <li>
                        ...
                        <li>
                            <p><strong>Website</strong> refers to Kepler, accessible from <a href="kepler.joshuaduda.com" rel="external nofollow noopener" target="_blank">kepler.joshuaduda.com</a></p>
                        </li>
                        <li>
