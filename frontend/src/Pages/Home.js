...
import solarEclipse from '../img/solar-eclipse.webp';
...
function Home() {
    ...
    <div className="flex flex-col">
        ...
        <div className="bg-solar bg-cover bg-center pb-40 mt-[50px]">
            ...
            <button to='/Calendar' className="float-right flex ml-20 mt-8 mr-10 bg-orange-600 text-black hover:bg-orange-300 text-xl font-bold p-4 rounded-lg z-10">View the Calendar </button>
        </div>
